...
class MyApp(QMainWindow):
    def __init__(self):
        super().__init__()
        self.ui = Ui_MainWindow()  # Sửa lỗi ở đây
        self.ui.setupUi(self)  # Đúng cách gọi setupUi()
        self.ui.btn_encrypt.clicked.connect(self.call_api_encrypt)
        self.ui.btn_decrypt.clicked.connect(self.call_api_decrypt)

    def call_api_encrypt(self):
        url = 'http://127.0.0.1:992/api/vigenere/encrypt'
        payload = {
    ...
    def call_api_decrypt(self):  # Sai indent trong đoạn code gốc
        url = "http://127.0.0.1:992/api/vigenere/decrypt"
        payload = {
